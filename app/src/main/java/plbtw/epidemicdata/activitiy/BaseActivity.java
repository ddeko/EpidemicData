...
import plbtw.epidemicdata.base.ActivityInterface;
...
public abstract class BaseActivity extends ActionBarActivity implements ActivityInterface {
    ...
    public RelativeLayout actionRightContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUICallbacks();
        showCustomActionBar();
   //     tvActionBarTitleCenter.setText("EpidemicData");
    }
    ...
    public void setActionBarTitle(String title) {
        if(tvActionBarTitle != null) {
            ...
            actionRightContainer.setVisibility(View.GONE);
        }
    }
